...
const AchievementsSection = () => {
  return (
    <div className="md:py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
      <div className="sm:border-[#33353F] sm:border rounded-md py-8 md:px-16 flex flex-col sm:flex-row items-center justify-around">
